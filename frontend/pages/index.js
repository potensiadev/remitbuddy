// 파일 위치: /frontend/pages/index.js
// 역할: 사용자가 처음 접속했을 때, 브라우저 언어를 감지하여 /en 또는 /ko로 보내주는 역할.
...
```react
// 파일 위치: /frontend/pages/[lang]/index.js
...
const ChevronDownIcon = ({ className }) => (
    <svg className={className} xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" />
    </svg>
);
const ArrowRightIcon = ({ className }) => (
    <svg className={className} xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" fill="none" viewBox="0 0 16 16" stroke="currentColor">
...
// --- i18n & Static Data ---
const translations = {
  en: { title: "How much should your<br/>family receive?", subtitle: "We’ll find the best exchange rate for you", amount_to_receive: "Amount to Receive", compare_button: "Find out the Best Rate", compare_again_button: "Compare Again", best_rate_badge: "Best Rate", real_time_summary: "Real-time Summary", loading_fast: "Finding best rates...", loading_slow: "Checking more options...", fee: "Fee", error_title: "Oops! Something went wrong.", error_message: "We couldn't fetch the remittance data. Please try again later.", select_country_title: "Select Country", total_needed: "Total KRW needed (estimation)" },
  ko: { title: "가족이 받을 금액은<br/>얼마인가요?", subtitle: "최고의 환율을 찾아드릴게요", amount_to_receive: "받는 금액", compare_button: "최고 환율 찾아보기", compare_again_button: "다시 비교하기", best_rate_badge: "최고 환율", real_time_summary: "실시간 비교 결과", loading_fast: "최고 환율을 찾고 있어요...", loading_slow: "더 많은 업체를 확인 중입니다...", fee: "수수료", error_title: "오류가 발생했습니다.", error_message: "송금 정보를 가져오는 데 실패했습니다. 잠시 후 다시 시도해주세요.", select_country_title: "국가 선택", total_needed: "예상 총 필요 원화" },
};
...
const MOCK_DATA = { "Vietnam": [ { provider: "Sentbe", base_rate: 18.5, fee: 2500, link: "[https://www.sentbe.com/](https://www.sentbe.com/)" }, { provider: "Hanpass", base_rate: 18.4, fee: 3000, link: "[https://www.hanpass.com/](https://www.hanpass.com/)" }, { provider: "Wirebarley", base_rate: 18.45, fee: 2700, link: "[https://www.wirebarley.com/](https://www.wirebarley.com/)" }, { provider: "GME", base_rate: 18.2, fee: 2800, link: "[https://www.gmeremit.com/](https://www.gmeremit.com/)" }, { provider: "E9Pay", base_rate: 18.3, fee: 2200, link: "[https://www.e9pay.co.kr/](https://www.e9pay.co.kr/)" }, ], "Philippines": [ { provider: "Sentbe", base_rate: 45.2, fee: 3000, link: "[https://www.sentbe.com/](https://www.sentbe.com/)" } ], "Cambodia": [{ provider: "Sentbe", base_rate: 33.1, fee: 5000, link: "[https://www.sentbe.com/](https://www.sentbe.com/)" }], "Myanmar": [{ provider: "Hanpass", base_rate: 15.2, fee: 5000, link: "[https://www.hanpass.com/](https://www.hanpass.com/)" }], "Thailand": [{ provider: "Wirebarley", base_rate: 3.0, fee: 4000, link: "[https://www.wirebarley.com/](https://www.wirebarley.com/)" }], "Uzbekistan": [{ provider: "GME", base_rate: 10.5, fee: 6000, link: "[https://www.gmeremit.com/](https://www.gmeremit.com/)" }], "Indonesia": [{ provider: "Sentbe", base_rate: 130.0, fee: 3500, link: "[https://www.sentbe.com/](https://www.sentbe.com/)" }], "SriLanka": [{ provider: "E9Pay", base_rate: 2.5, fee: 5500, link: "[https://www.e9pay.co.kr/](https://www.e9pay.co.kr/)" }], "Bangladesh": [{ provider: "Hanpass", base_rate: 1.0, fee: 6000, link: "[https://www.hanpass.com/](https://www.hanpass.com/)" }], "Nepal": [ { provider: "Sentbe", base_rate: 110.5, fee: 4000, link: "[https://www.sentbe.com/](https://www.sentbe.com/)" } ] };
...
export default function LangIndexPage() {
    ...
    // `lang`이 아직 로드되지 않았을 때를 위한 로딩 상태
    if (!lang) {
...
export async function getStaticPaths() {
    const paths = ['en', 'ko'].map(lang => ({ params: { lang } }));
