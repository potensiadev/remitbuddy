    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
                ...
                <section id="about" className="bg-gradient-to-br from-brand-50 via-white to-brand-50/30 pt-20 pb-12 sm:pt-24 sm:pb-16 md:pt-32 md:pb-24 relative overflow-hidden">
