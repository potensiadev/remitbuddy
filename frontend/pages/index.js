...
const COUNTRIES = [ { code: "VN", currency: "VND", name: "Vietnam", flag: "https://placehold.co/28x28/DA251D/FFFF00?text=V" }, { code: "PH", currency: "PHP", name: "Philippines", flag: "https://placehold.co/28x28/0038A8/FFFFFF?text=P" }, { code: "KH", currency: "KHR", name: "Cambodia", flag: "https://placehold.co/28x28/032EA1/FFFFFF?text=K" }, { code: "MM", currency: "MMK", name: "Myanmar", flag: "https://placehold.co/28x28/FECB00/FFFFFF?text=M" }, { code: "TH", currency: "THB", name: "Thailand", flag: "https://placehold.co/28x28/A51931/FFFFFF?text=T" }, { code: "UZ", currency: "UZS", name: "Uzbekistan", flag: "https://placehold.co/28x28/0072CE/FFFFFF?text=U" }, { code: "ID", currency: "IDR", name: "Indonesia", flag: "https://placehold.co/28x28/CE1126/FFFFFF?text=I" }, { code: "LK", currency: "LKR", name: "SriLanka", flag: "https://placehold.co/28x28/FFD700/8D1B3D?text=S" }, { code: "BD", currency: "BDT", name: "Bangladesh", flag: "https://placehold.co/28x28/006A4E/F42A41?text=B" }, { code: 'NP', name: 'Nepal', currency: 'NPR', flag: 'https://placehold.co/28x28/DC143C/FFFFFF?text=N' }, ];
...
export default function MainPage() {
    ...
    useEffect(() => {
        // Switch language for demo purposes
        // In a real app, this might come from user settings or browser detection
