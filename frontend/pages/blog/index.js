  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col safe-top safe-bottom">
        ...
        <main className="flex-grow pt-24 sm:pt-32 pb-16 lg:pb-24">
          <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
                ...
                <Link href={`/blog/${post.slug}`} key={post.id} className="group flex flex-col bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-gray-100">
                  ...
                  <div className="relative h-48 sm:h-56 bg-gradient-to-br from-blue-50 to-indigo-100 overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                      <svg className="w-16 h-16 text-blue-200/50" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {(!posts || posts.length === 0) && (
              <div className="text-center py-24 bg-white rounded-3xl border border-dashed border-gray-200">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">{t('blog.empty_title', 'No posts found')}</h3>
                <p className="text-gray-500">{t('blog.empty_desc', 'Check back soon for new updates!')}</p>
              </div>
            )}
